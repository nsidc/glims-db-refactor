...
--
-- Name: glims_v2_field_dictionary; Type: TABLE; Schema: public; Owner: braup
--
...
--
-- Name: glims_v2_table_fields; Type: TABLE; Schema: public; Owner: braup
--
...
CREATE INDEX glacier_poly_index ON public.glacier_entities USING gist (entity_geom);

ALTER TABLE public.glacier_entities CLUSTER ON glacier_poly_index;
...
GRANT SELECT ON TABLE public.glacier_entities TO aster_metadata;
